...
// LEFTOFF: this is still basically the same as the normal asserter, minus name changes.
...
type TestifySuiteAsserter struct {
	testingT *testing.T
}

func MakeTestifySuiteAsserter(t *testing.T) *TestifySuiteAsserter {
	return &TestifySuiteAsserter{t}
}

// func (t *tester) equals[C comparable](actual C, expected C) bool {

func (a *TestifySuiteAsserter) PrintDivider() {
	fmt.Println("=========================================================")
}
...
func (a *TestifySuiteAsserter) GetRelevantStack(numBackUp int) []string {
...
//	If your code is one level above an assertion, give 2.
//	If you want to see the whole stack trace, give 0.
func (a *TestifySuiteAsserter) PrintStack(numBackUp int) {
...
func (a *TestifySuiteAsserter) Equal(expected any, actual any) {
	if !(expected == actual) {
		a.PrintDivider()
...
func (a *TestifySuiteAsserter) NotEqual(expected any, actual any) {
	if !(expected != actual) {
		a.PrintDivider()
...
func (a *TestifySuiteAsserter) True(actual bool) {
	if !actual {
		a.PrintDivider()
...
func (a *TestifySuiteAsserter) NotTrue(actual bool) {
	if actual {
		a.PrintDivider()
...
func (a *TestifySuiteAsserter) False(actual bool) {
	if actual {
		a.PrintDivider()
		a.testingT.Errorf("got 'true', but expected to get 'false'.")
		a.PrintStack(1)
...
func genericLT[NUM Number](a *TestifySuiteAsserter, left NUM, right NUM) {
	if !(left < right) {
		a.PrintDivider()
...
func genericGT[NUM Number](a *TestifySuiteAsserter, left NUM, right NUM) {
	if !(left > right) {
		a.PrintDivider()
...
func genericLE[NUM Number](a *TestifySuiteAsserter, left NUM, right NUM) {
	if !(left <= right) {
		a.PrintDivider()
...
func genericGE[NUM Number](a *TestifySuiteAsserter, left NUM, right NUM) {
	if !(left >= right) {
		a.PrintDivider()
...
func (a *TestifySuiteAsserter) LT(left any, right any) { // we assume these are the same type
...
func (a *TestifySuiteAsserter) GT(left any, right any) { // we assume these are the same type
	switch leftCasted := left.(type) {
	// , int8, int16, int32, int64, uint, uint8, uint16, uint32, uint64, uintptr, float32, float64,
	case int:
		switch rightCasted := right.(type) {
...
func (a *TestifySuiteAsserter) LE(left any, right any) { // we assume these are the same type
	switch leftCasted := left.(type) {
	// , int8, int16, int32, int64, uint, uint8, uint16, uint32, uint64, uintptr, float32, float64,
	case int:
		switch rightCasted := right.(type) {
...
func (a *TestifySuiteAsserter) GE(left any, right any) { // we assume these are the same type
	switch leftCasted := left.(type) {
	// , int8, int16, int32, int64, uint, uint8, uint16, uint32, uint64, uintptr, float32, float64,
	case int:
		switch rightCasted := right.(type) {
